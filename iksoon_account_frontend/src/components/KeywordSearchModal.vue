  ...
  <div class="modal-backdrop" @click.self="handleClose">
    <div class="modal-content" :class="{ 'mobile-modal': isMobile }">
      ...
      <div class="flex items-center justify-between p-6 border-b border-gray-200">
        ...
        <el-button @click="handleClose" size="large" circle>×</el-button>
      </div>
...
.modal-content {
  @apply bg-white rounded-xl shadow-2xl w-full max-w-6xl max-h-[95vh] overflow-hidden flex flex-col;
  animation: slideIn 0.3s ease-out;
}

.mobile-modal {
  @apply fixed top-0 left-0 right-0 bottom-0 w-screen h-screen max-w-none max-h-none m-0 rounded-none;
}
